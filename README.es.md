...
**Un completo dataset de ejercicios de fitness listo para usar con 1.324 ejercicios — cada uno con animación GIF, miniatura de 180×180, categoría, zona corporal, equipamiento, músculo objetivo y grupo muscular, e instrucciones paso a paso en 10 idiomas (español por defecto, inglés, etc.).**
